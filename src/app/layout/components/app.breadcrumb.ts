    ...
    template: ` <nav>
        ...
        <ul class="breadcrumb-menu flex items-center justify-end lg:hidden absolute right-0 top-0 z-40 h-12 w-screen">
            ...
            <li class="right-panel-button relative">
                <button pButton pRipple type="button" label="Wallet" style="width: 6.7rem" icon="pi pi-bookmark" class="layout-rightmenu-button !hidden md:!inline-flex font-normal" (click)="onProfileMenuButtonClick()"></button>
